...
public class RegisterID {
	...
	public static String getRegisterID() throws NoSuchAlgorithmException, UnsupportedEncodingException, Exception{
		String ret = new String(encryptSHA(Util.EncoderByMd5(Util.stringEncrypt(getRegisterIDRaw())).getBytes()));
